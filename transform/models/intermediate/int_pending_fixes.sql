...
-- released — the pending release. Same supply-side signal the projection
-- models use (int_backpatch_fixes): backpatched
-- stable-branch commits since the last wrap (the content cutoff of the release
